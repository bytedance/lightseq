...
act_quant_config = QuantDescriptor(
    num_bits=8, narrow_range=True, learn_amax=True, amax=7.0
)
out_quant_config = QuantDescriptor(
    num_bits=8, narrow_range=True, learn_amax=True, amax=7.0
)
relu_quant_config = QuantDescriptor(
    num_bits=8, narrow_range=True, learn_amax=True, amax=7.0, unsigned=True
)
weight_quant_config = QuantDescriptor(
    num_bits=8, narrow_range=True, learn_amax=True, amax=0.5
)

...
void TransformerDecoderLayer<T>::self_attn_layer_fw(const T *input_ptr,
  ...
  _attn_out_linear_v3.Forward(_attn_ow_ptr, _attn_output_ptr, output_ptr,
                              _cublasLtHandle, _stream);
...
void TransformerDecoderLayer<T>::encdec_kv_fw(const T *enc_output_ptr) {
  ...
  _encdec_kv_linear_v3.Forward(_encdec_attn_kvw_ptr, enc_output_ptr,
...
void TransformerDecoderLayer<T>::encdec_attn_layer_fw(const T *input_ptr,
  ...
  _encdec_q_linear_v3.Forward(_encdec_attn_qw_ptr, _gemmQ_inp_ptr, buffer,
                              _cublasLtHandle, _stream);
  ...
  _encdec_attn_out_linear_v3.Forward(_encdec_attn_ow_ptr,

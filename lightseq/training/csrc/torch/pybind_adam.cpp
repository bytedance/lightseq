...
void apex_adam(at::Tensor& p_copy, at::Tensor& m, at::Tensor& v, at::Tensor& g,
  ...
  AT_ASSERTM(g.numel() == num_elem,
             "number of elements in g and p tensors should be equal");
  apex_fused_adam_cuda(p_copy, m, v, g, lr, beta1, beta2, eps, grad_scale, step,
                       mode, bias_correction, decay);
}

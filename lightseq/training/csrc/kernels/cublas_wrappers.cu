...
int cublas_gemm_ex(cublasHandle_t handle, cublasOperation_t transa,
  ...
  cublasStatus_t status = cublasGemmEx(handle, transa, transb, m, n, k, (const void *)alpha,
...
int cublas_gemm_ex(cublasHandle_t handle, cublasOperation_t transa,
  ...
  rocblas_status status = rocblas_gemm_ex(
      ...
      rocblas_datatype_f16_r, m, (void *)C, rocblas_datatype_f16_r, m, rocblas_datatype_f16_r, algo, 0, 0);  
#else
                   cublasGemmAlgo_t algo) {

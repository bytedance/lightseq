...
Variable* BiasAddTrans20314<T1, T2>::operator()(Variable* inp, Variable* bias) {
    ...
    Variable* res =
      new Variable(this->_name + "/res", trans_size * sizeof(T1), trans_size * sizeof(T2));
...
void BiasAddTrans20314<T1, T2>::forward() {
    ...
    //   [b, nh, s, ad] -> [b, s, nh, ad]
    launch_transform4d_0213<T1>(res_ptr, inp_ptr, _batch, _seq_len,
...
void BiasAddTrans20314<T1, T2>::backward() {
    ...
    launch_transform_0213<T2>(inp_grad, out_grad, _batch,

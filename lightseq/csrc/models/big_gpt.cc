...
namespace lightseq {
namespace cuda {
BigGpt::BigGpt(const std::string weight_path, const int max_batch_size)
...
void BigGpt::set_input_ptr(int index, void *input_ptr) {
  switch (index) {
    case 0:
...
void BigGpt::set_output_ptr(int index, void *output_ptr) {
  switch (index) {
    case 0:
...
const void *BigGpt::get_output_ptr(int index) {
  switch (index) {
    case 0:
...
std::vector<int> BigGpt::get_input_max_shape(int index) {
  switch (index) {
    case 0:
...
std::vector<int> BigGpt::get_output_max_shape(int index) {
  switch (index) {
    case 0:
...
DataType BigGpt::get_input_dtype(int index) {
  switch (index) {
    case 0:
...
DataType BigGpt::get_output_dtype(int index) {
  switch (index) {
    case 0:
      return DataType::kInt32;
      break;

...
int cublas_gemm_ex(cublasHandle_t handle, cublasOperation_t transa,
                   cublasOperation_t transb, int m, int n, int k,
                   const __half *alpha, const __half *beta, const __half *A,
...
int cublas_strided_batched_gemm(
    cublasHandle_t handle, int m, int n, int k, const __half *alpha,
    const __half *beta, const __half *A, const __half *B, __half *C,

...
DeltalmEncoder<OpType_>::DeltalmEncoder(int max_batch_size, int *p_d_token_id,
                          int *p_d_padding_mask, _DataType *p_d_output,
                          const DeltalmWeight<OpType_> &tw,
...
*/
template <OperationType OpType_>
long DeltalmEncoder<OpType_>::compute_buffer_bytesize() {
...
*/
template <OperationType OpType_>
void DeltalmEncoder<OpType_>::init_buffer(void *pbuf) {
...
*/
template <OperationType OpType_>
std::string DeltalmEncoder<OpType_>::check() {
...
*/
template <OperationType OpType_>
void DeltalmEncoder<OpType_>::run_one_infer(int batch_size, int batch_seq_len) {
...
*/
template <OperationType OpType_>
void DeltalmEncoder<OpType_>::self_attention() {
...
template <OperationType OpType_>
void DeltalmEncoder<OpType_>::ffn_add_norm() {
  /* ---step 0. layer_norm, add output_bias to "query"--- */
  ker_norm_layer_resual_launcher<_DataType>(
...
template class DeltalmEncoder<OperationType::FP16>;
template class DeltalmEncoder<OperationType::FP32>;

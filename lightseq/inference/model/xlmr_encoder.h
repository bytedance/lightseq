...
class XLMREncoder {
 private:
  ...
  const int *_p_d_lang_id;   // input lang id [batch_size, batch_seq_len]
 ...
 public:
  XLMREncoder(int max_batch_size, const int *p_d_token_id,
              const int *_p_d_lang_id, int *p_d_padding_mask,
              _DataType *p_d_output, const XLMRWeight<OpType_> &tw,

...
class DeltalmEncoder {
 private:
  ...
  const DeltalmWeight<OpType_> &_tw;
 ...
 public:
  DeltalmEncoder(int max_batch_size, int *p_d_token_id, int *p_d_padding_mask,
          _DataType *p_d_output, const DeltalmWeight<OpType_> &tw,

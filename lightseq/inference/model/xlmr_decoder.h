...
class XLMRDecoder {
 ...
 public:
  XLMRDecoder(int max_batch_size, const int* p_d_padding_mask,
              const int* p_d_lang_id, const _DataType* p_d_encoder_output,
              int* p_d_result, XLMRWeight<OpType_>& tw, cudaStream_t stream,
